...
This squad manages all `gtcx-operations` work in ClickUp. Source of truth for sprint commitments and backlog priority is git (`docs/agile/`), but ClickUp is the operational execution layer.
