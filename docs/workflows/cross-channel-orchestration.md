...
The orchestration engine (`scripts/orchestrate-cross-channel.ts`) evaluates 5 rules against every thread:
...
Add new rules to `scripts/orchestrate-cross-channel.ts`:
...
- [WhatsApp-First Communications](../strategy/whatsapp-first-communications.md)
- [Audience Segmented Communications](../strategy/audience-segmented-communications.md)
