...
├── docs/agile/sprints/current.md   # Sprint commitments
└── scripts/
...
This reads all repo sprint docs (`docs/agile/sprints/current.md`) and creates/updates corresponding ClickUp tasks.
...
- [Google Workspace Setup](../ops/google-workspace-setup.md)
