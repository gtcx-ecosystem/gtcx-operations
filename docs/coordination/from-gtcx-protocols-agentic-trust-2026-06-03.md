...
| Sink (SoR) | gtcx-protocols | `docs/audit/evidence/inf-86-xr-401-agentic-attestation-latest.json` |
...
| Zod mirror schema | `src/schemas/agentic-attestation.ts` | Done |
...
| Repo | Pickup |
| --- | --- |
| gtcx-agentic | `gtcx-protocols/docs/coordination/to-gtcx-agentic-pickup-2026-06-03.md` |
| gtcx-operations | `gtcx-protocols/docs/coordination/to-gtcx-operations-pickup-2026-06-03.md` |
| gtcx-infrastructure | `gtcx-protocols/docs/operations/coordination/to-gtcx-infrastructure-inf-86-ceremony-2026-06-03.md` |
