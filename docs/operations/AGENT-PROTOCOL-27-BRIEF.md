...
If sandbox/credentials block you: Permission Unblock Report (see docs/operations/agent-execution-obligation.md)

Cross-repo INF-86: cd ../gtcx-protocols && pnpm check:inf86-xr401-preceremony — you run it, not me.

Manifest: docs/operations/agent-execution-obligation.md
```
