...
protocol: gtcx-docs/docs/governance/protocols/19-agent-credential-access/protocol.md
adoption_status: established
---

# Agent Credential Access — gtcx-operations

> **Protocol:** [Protocol 19](https://github.com/gtcx-ecosystem/gtcx-docs/blob/main/docs/governance/protocols/19-agent-credential-access/protocol.md)  
