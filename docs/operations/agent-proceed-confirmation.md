...
protocol: gtcx-docs/docs/governance/protocols/26-agent-proceed-confirmation/protocol.md
adoption_status: established
---

# Agent Proceed Confirmation — gtcx-operations

> **Protocol:** [Protocol 26 — Agent Proceed Confirmation](https://github.com/gtcx-ecosystem/gtcx-docs/blob/main/docs/governance/protocols/26-agent-proceed-confirmation/protocol.md)  
...
2. Read [`docs/coordination/ECOSYSTEM-CRITICAL-PATH-INF-86-POINTER.md`](../coordination/ECOSYSTEM-CRITICAL-PATH-INF-86-POINTER.md) when story touches INF-86 or sibling repos.
...
**Owner repo:** …
**Because:** …
**Artifact:** docs/coordination/to-<repo>-….md
