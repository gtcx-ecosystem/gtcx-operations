...
import { validateWithZod, printResults, type ValidationResult } from '../03-platform/src/utils/validate.js';
...
import { EmailProviderConfigSchema, EmailTemplateSchema, EmailLogSchema, EmailCampaignSchema } from '../03-platform/src/schemas/email.js';
import { WhatsAppProviderSchema, WhatsAppTemplateSchema, WhatsAppMessageSchema } from '../03-platform/src/schemas/whatsapp.js';
import { CrmRegistrySchema, CrmContactSchema, CrmCompanySchema, CrmInteractionSchema } from '../03-platform/src/schemas/crm.js';
