...
function checkRepo(repo: string): ChecklistItem[] {
...
function checkLicense(repoPath: string): boolean {
  try {
...
function generateMarkdown(repo: string, items: ChecklistItem[]): string {
