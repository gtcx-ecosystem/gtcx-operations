...
const TEMPLATES = [
    ...
    },
    {
        ...
        evidenceSources: ["01-docs/04-ops/sla.md", "status page URL", "01-docs/04-ops/dr-drill-evidence.md"],
    ...
    },
    {
        ...
        evidenceSources: ["01-docs/09-security/classification-policy.md", ".github/workflows/ci.yml", "k8s secret configs"],
        responsibleParty: "security-engineer",
        frequency: "annual",
    },
];
...
main();
//# sourceMappingURL=generate-soc2-evidence.js.map