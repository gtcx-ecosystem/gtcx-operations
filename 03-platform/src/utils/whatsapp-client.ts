...
export class MockWhatsAppClient implements WhatsAppClient {
  ...
  async sendTemplate(to: string, template: WhatsAppTemplate, variables: Record<string, string>): Promise<WhatsAppSendResult> {
...
export class TwilioWhatsAppClient implements WhatsAppClient {
  async send(message: WhatsAppMessage, config: WhatsAppProvider): Promise<WhatsAppSendResult> {
  ...
  async sendTemplate(to: string, template: WhatsAppTemplate, variables: Record<string, string>, config: WhatsAppProvider): Promise<WhatsAppSendResult> {
...
export function getWhatsAppClient(config: WhatsAppProvider): WhatsAppClient {
...
export function generateWhatsAppId(): string {
