 ...
 * Run: `tsx scripts/dirty-file-audit.ts <repo-name>`
 */
...
function categorizeFile(path: string): { category: string; action: string; reason: string } {
...
function auditRepo(repo: string) {
