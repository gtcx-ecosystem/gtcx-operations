...
const manifest = requireFile('docs/operations/agent-work-selection.md', 'work-selection manifest');
requireFile('scripts/agent-next-work.mjs', 'selection script');
requireFile('docs/strategy/execution-roadmap.md', 'execution roadmap');
const autoDev = requireFile('docs/audit/auto-dev-state.md', 'session pointer');
requireFile('docs/operations/AGENT-PROTOCOL-22-BRIEF.md', 'agent brief');
...
const p24 = requireFile('docs/operations/cross-repo-coordination.md', 'Protocol 24 doc');
if (!p24?.includes('Protocol 24')) {
  errors.push('Missing or incomplete docs/operations/cross-repo-coordination.md');
}
