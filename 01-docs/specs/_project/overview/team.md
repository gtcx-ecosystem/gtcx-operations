...
This squad manages all `gtcx-operations` work in ClickUp. Source of truth for sprint commitments and backlog priority is git (`01-docs/specs/_project/planning/`), but ClickUp is the operational execution layer.
