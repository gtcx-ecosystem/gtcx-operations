...
> **Reference:** [exploration-os agent-work-selection](https://github.com/gtcx-ecosystem/exploration-os/blob/main/01-docs/04-ops/agent-work-selection.md)  
...
| `ops-docs` | Author `01-docs/`, runbook, manifest, pointer | **Select** |
...
4. Mark `in_progress` in `01-docs/strategy/execution-roadmap.md`.
...
P0 stories blocked on sibling repos (OPS-02 → baseline-os, OPS-08 → gtcx-core): file `01-docs/06-coordination/to-<repo>-*.md` and update `dependencies.md` in the **same session**. See [`cross-repo-coordination.md`](./cross-repo-coordination.md).
