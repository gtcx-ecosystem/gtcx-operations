...
├── 01-docs/specs/_project/planning/sprints/current.md   # Sprint commitments
└── 03-platform/scripts/
...
This reads all repo sprint docs (`01-docs/specs/_project/planning/sprints/current.md`) and creates/updates corresponding ClickUp tasks.
