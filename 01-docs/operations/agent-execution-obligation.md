...
protocol: gtcx-docs/01-docs/governance/protocols/27-agent-execution-obligation/protocol.md
adoption_status: established
---

# Agent Execution Obligation — gtcx-operations

> **Normative:** [Protocol 27](https://github.com/gtcx-ecosystem/gtcx-docs/blob/main/01-docs/governance/protocols/27-agent-execution-obligation/protocol.md)  
...
2. Place credentials per `01-docs/engineering/guides/google-workspace-setup.md` if integration scripts required
